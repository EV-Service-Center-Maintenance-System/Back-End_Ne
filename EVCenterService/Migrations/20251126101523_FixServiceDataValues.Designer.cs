...
namespace EVCenterService.Migrations
{
    ...
    [Migration("20251126101523_FixServiceDataValues")]
    partial class FixServiceDataValues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EVCenterService.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin",
                            Password = "AQAAAAIAAYagAAAAELV1us4OlzpO4+HG0PjsxC0GXZdHf5ArQ/L5zBvh9rPdls/qtZ61qah7QSXNTLPvpQ==",
                            Phone = "0901000001",
                            Role = "Admin",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Tran Van B",
                            Password = "AQAAAAIAAYagAAAAEHQf6azJWUsRxxLuzz6/KWXbfqO7oD9qmSpXBXGg5j9a233dy5hi+RoBAGBXHqo+cQ==",
                            Phone = "0902000002",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Le Thi C",
                            Password = "AQAAAAIAAYagAAAAEIu5TINK2/xmopLvfIIiJWkUunzrq2zbGawZ9MQTHR7EXZyb0aKBmAoX30LeaMSOUg==",
                            Phone = "0903000003",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Phan Anh C",
                            Password = "AQAAAAIAAYagAAAAEEi5Ym6/tnanmbIBHzaH8/9EJFXGeuJHV3wMr2zi9t3PjZhXWa8LuAuLbOF3uCcwjQ==",
                            Phone = "0906000006",
                            Role = "Staff",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Pham Van D",
                            Password = "AQAAAAIAAYagAAAAEEw9C8ulp31TmdfsDNTsL+k2iPovA5opXoEywP05JATA50vUxHSmPdMgxkAtnKFB7Q==",
                            Phone = "0904000004",
                            Role = "Customer",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Do Thi E",
                            Password = "AQAAAAIAAYagAAAAEA9zCWQxYYKsYYg6drVdxtw2KwEinyrCpTHbG/l4TfsT2j8daSiAclqMuMckTQG/Rw==",
                            Phone = "0905000005",
                            Role = "Customer",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEONdZPrQFtrrSaF2r6jDD0R2GA4FgwSAST5KIPAWzyVpB/2G/VCyAd6VVlaz+Huh0w==",
                            Phone = "0908000008",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Vu Dinh H",
                            Password = "AQAAAAIAAYagAAAAEBb6IkpggZSvLBQYQ5n53CKZhzfcWhrD4xJcioyKvM8eRFp2DZbhEMUlYAChNQDGOA==",
                            Phone = "0910000010",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEHaM9LLrBe1/xXYxhJV7fNrEMSC9dRvDAC97vx+0fLllXo9LZjw5FHJJTKrqSmQ0Gw==",
                            Phone = "0909000009",
                            Role = "Staff",
                            Status = "Active"
                        });
            ...
            modelBuilder.Entity("EVCenterService.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 26, 17, 15, 22, 602, DateTimeKind.Local).AddTicks(1835),
                            OrderId = 1,
                            Rating = 5,
                            UserId = new Guid("e5e5e5e5-eeee-eeee-eeee-eeeeeeeeeeee")
                        });
            ...
            modelBuilder.Entity("EVCenterService.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TriggerDate = new DateTime(2025, 11, 26, 17, 15, 22, 602, DateTimeKind.Local).AddTicks(1792),
                            Type = "StatusUpdate"
                        },
                        new
                        {
                            ...
                            TriggerDate = new DateTime(2025, 11, 26, 17, 15, 22, 602, DateTimeKind.Local).AddTicks(1794),
            ...
            modelBuilder.Entity("EVCenterService.Models.ServiceCatalog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ServiceId = 5,
                            BasePrice = 200000m,
                            Description = "Kiểm tra áp suất và độ mòn",
                            DurationMinutes = 30,
                            IncludeInChecklist = true,
            ...
            modelBuilder.Entity("EVCenterService.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            AutoRenew = true,
                            CreatedAt = new DateTime(2025, 11, 26, 17, 15, 22, 602, DateTimeKind.Local).AddTicks(1724),
