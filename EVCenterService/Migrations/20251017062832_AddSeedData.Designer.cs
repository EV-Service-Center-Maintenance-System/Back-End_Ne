...
namespace EVCenterService.Migrations
{
    ...
    [Migration("20251017062832_AddSeedData")]
            ...
            modelBuilder.Entity("EVCenterService.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("85b2a152-e189-42bc-bf35-6bc61fdd2295"),
                        ...
                        new
                        {
                            UserId = new Guid("4cad7706-115f-4b35-a0c5-23e3ac3005f5"),
                        ...
                        new
                        {
                            UserId = new Guid("d2cc8dfd-b5fd-43a1-9c9d-707f9beda2cd"),
                        ...
                        new
                        {
                            UserId = new Guid("cbafbbfa-4088-40fc-b38f-86d8ebe3b15e"),
                        ...
                        new
                        {
                            UserId = new Guid("901e7662-d51b-42f0-8826-53f100caf68a"),
                        ...
                        new
                        {
                            UserId = new Guid("56755807-5aff-4e3e-9e69-7108020cb8cf"),
            ...
            modelBuilder.Entity("EVCenterService.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 17, 13, 28, 31, 959, DateTimeKind.Local).AddTicks(3512),
                            OrderId = 1,
                            Rating = 5,
                            UserId = new Guid("901e7662-d51b-42f0-8826-53f100caf68a")
                        });
            ...
            modelBuilder.Entity("EVCenterService.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = "Paid",
                            SubscriptionId = new Guid("4ca95637-b9e9-48fd-8019-845e35a79543")
                        });
                });
            ...
            modelBuilder.Entity("EVCenterService.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsRead = false,
                            ReceiverId = new Guid("901e7662-d51b-42f0-8826-53f100caf68a"),
                            TriggerDate = new DateTime(2025, 10, 17, 13, 28, 31, 959, DateTimeKind.Local).AddTicks(3493),
                            Type = "StatusUpdate"
                        },
                        new
                        {
                            ...
                            IsRead = false,
                            ReceiverId = new Guid("56755807-5aff-4e3e-9e69-7108020cb8cf"),
                            TriggerDate = new DateTime(2025, 10, 17, 13, 28, 31, 959, DateTimeKind.Local).AddTicks(3495),
            ...
            modelBuilder.Entity("EVCenterService.Models.Slot", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TechnicianId = new Guid("4cad7706-115f-4b35-a0c5-23e3ac3005f5")
                        },
                        new
                        {
                            SlotId = 2,
                            ...
                            TechnicianId = new Guid("d2cc8dfd-b5fd-43a1-9c9d-707f9beda2cd")
                        });
                });
            ...
            modelBuilder.Entity("EVCenterService.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("4ca95637-b9e9-48fd-8019-845e35a79543"),
                            AutoRenew = true,
                            CreatedAt = new DateTime(2025, 10, 17, 13, 28, 31, 959, DateTimeKind.Local).AddTicks(3447),
                            EndDate = new DateTime(2025, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PlanId = new Guid("fd490afc-90cc-4bf4-90ae-adfacacd2fcd"),
            ...
            modelBuilder.Entity("EVCenterService.Models.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PlanId = new Guid("b4d0b3bd-dda4-4032-9d6a-da64745aa38e"),
