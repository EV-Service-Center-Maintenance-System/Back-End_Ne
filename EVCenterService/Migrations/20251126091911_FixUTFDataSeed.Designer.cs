...
namespace EVCenterService.Migrations
{
    ...
    [Migration("20251126091911_FixUTFDataSeed")]
    partial class FixUTFDataSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EVCenterService.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin",
                            Password = "AQAAAAIAAYagAAAAEBrD+2NJdBr2FH6Cwj3pOeBOcvfe/rIs+9A2TudGXvpxGHdSWAmLL46aSbn/EPhjRw==",
                            Phone = "0901000001",
                            Role = "Admin",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Tran Van B",
                            Password = "AQAAAAIAAYagAAAAEEuzXA0bPC8h72SrAd74UVUTZS+0AiJXLBZzpy+MH8QvP8CpNmiD3/c2WRUcjRBhNQ==",
                            Phone = "0902000002",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Le Thi C",
                            Password = "AQAAAAIAAYagAAAAENRPel+ud4W11+lXaKKfOlnHtbYgqw+xRPRvIhebYmDU645rv7arU3Vvu2C+bRsvIA==",
                            Phone = "0903000003",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Phan Anh C",
                            Password = "AQAAAAIAAYagAAAAENPaUc63Std0wpcxEphWWnvhJOAVsVQquS+PCHOcOW/7EMyYL4zc/Mc182rhAqaC2g==",
                            Phone = "0906000006",
                            Role = "Staff",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Pham Van D",
                            Password = "AQAAAAIAAYagAAAAEIUMVDVH/FhX9uQIqEjlokXWOibVUN6HYWEf8Q8gP2Vp5VrLxpHh9olGyoOlJGIWkw==",
                            Phone = "0904000004",
                            Role = "Customer",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Do Thi E",
                            Password = "AQAAAAIAAYagAAAAEI/DpRTOnLOtUzSXKEqHQtu8u9p2JyJvywqf2pxWgtEp+PggX2yB1FLt3N0RLcF4sg==",
                            Phone = "0905000005",
                            Role = "Customer",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEHg+CF8XhyTGyffn0V9nj1M09eo97k7i2kggdQDn1mcMVVvFG4wClnyr2NpseZpinw==",
                            Phone = "0908000008",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            FullName = "Vu Dinh H",
                            Password = "AQAAAAIAAYagAAAAEOvX8KvBjXYB9nq3kGniwOCYIBS+nrDynMX3OBJ8hyN6NzkAMgWoBXGvM6TVEQc3qA==",
                            Phone = "0910000010",
                            Role = "Technician",
                            Status = "Active"
                        },
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEI9BfiAG1elYpjpivBOCPjgKNtwGJKB8rfkn7Eumhyzei8dVR8KvQ/NAfmcHZPYRJw==",
                            Phone = "0909000009",
                            Role = "Staff",
                            Status = "Active"
                        });
            ...
            modelBuilder.Entity("EVCenterService.Models.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 11, 26, 16, 19, 10, 629, DateTimeKind.Local).AddTicks(1579),
                            OrderId = 1,
                            Rating = 5,
                            UserId = new Guid("e5e5e5e5-eeee-eeee-eeee-eeeeeeeeeeee")
                        });
            ...
            modelBuilder.Entity("EVCenterService.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TriggerDate = new DateTime(2025, 11, 26, 16, 19, 10, 629, DateTimeKind.Local).AddTicks(1555),
                            Type = "StatusUpdate"
                        },
                        new
                        {
                            ...
                            TriggerDate = new DateTime(2025, 11, 26, 16, 19, 10, 629, DateTimeKind.Local).AddTicks(1558),
            ...
            modelBuilder.Entity("EVCenterService.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("33333333-3333-3333-3333-333333333333"),
                            AutoRenew = true,
                            CreatedAt = new DateTime(2025, 11, 26, 16, 19, 10, 629, DateTimeKind.Local).AddTicks(1465),
